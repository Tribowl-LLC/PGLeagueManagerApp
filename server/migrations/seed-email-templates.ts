...
export const DEFAULT_TEMPLATES: InsertEmailTemplate[] = [
  ...
  {
    slug: "bowler_registration_invite",
    name: "Bowler Registration Invitation",
    description: "Sent to an ordinary bowler with a link to the public SMS registration page.",
    subject: "Register for {{organization_name}} on LeagueVault",
    body: "<p>Hi {{bowler_name}},</p><p>{{organization_name}} invited you to register on LeagueVault.</p><p>Use the public registration page to enter your name, email, and phone number. We will text you a six-digit verification code.</p><p><a href=\"{{register_link}}\">Register on LeagueVault</a></p><p>If you did not expect this message, you can safely ignore it.</p>",
    active: true,
  },
  {
    slug: "profile_claim_notification",
    name: "Profile Claim Notification",
    description: "Alerts the prior roster contact when a bowler profile is linked to an account.",
    subject: "A LeagueVault profile was connected",
    body: "<p>Hi {{user_name}},</p><p>An account was connected to <strong>{{bowler_name}}</strong> in {{organization_name}}.</p><p>If you did not make or authorize this connection, use the secure link below:</p><p><a href=\"{{report_link}}\">This wasn't me</a></p><p>If you recognize this activity, no action is needed.</p>",
    active: true,
  },
  {
    slug: "profile_claim_account_ready",
    name: "Profile Claim and Account Ready",
    description: "Combines the profile-claim security notice and account-ready sign-in instructions when they share a recipient.",
    subject: "Your LeagueVault account and profile connection",
    body: "<p>Hi {{user_name}},</p><p>Your LeagueVault account is ready and an account was connected to <strong>{{bowler_name}}</strong> in {{organization_name}}.</p><p><a href=\"{{login_link}}\">Sign in to LeagueVault</a> or open your <a href=\"{{dashboard_link}}\">bowler dashboard</a>.</p><p>If you did not make or authorize this connection, use the secure link below:</p><p><a href=\"{{report_link}}\">This wasn't me</a></p><p>If you recognize this activity, no action is needed.</p>",
    active: true,
  },
  {
    slug: "email_change_old_address_approval",
    name: "Email Change Old Address Approval",
    description: "Requires the current mailbox to approve a protected login-email change.",
    subject: "Approve a LeagueVault email change",
    body: "<p>Hi {{user_name}},</p><p>A request was made to change this account's login email to <strong>{{new_email_masked}}</strong>.</p><p>The new address cannot replace this address until you approve the request.</p><p><a href=\"{{approval_link}}\">Approve this email change</a></p><p>If you did not request this, take no action and contact your administrator.</p>",
    active: true,
  },
  {
    slug: "email_change_completed_notification",
    name: "Email Change Completed Notification",
    description: "Notifies the previous mailbox after a protected login-email change completes.",
    subject: "Your LeagueVault email was changed",
    body: "<p>Hi {{user_name}},</p><p>The login email for your LeagueVault account was changed to <strong>{{new_email_masked}}</strong>.</p><p>If you did not authorize this change, contact support immediately: <a href=\"{{support_link}}\">{{support_link}}</a></p>",
    active: true,
  },
  {
