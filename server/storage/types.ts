...
export interface ILeagueStorage {
  ...
  archiveLeague(id: number, organizationId?: number | null): Promise<League>;
...
export interface IPaymentStorage {
  ...
  getPaymentEvidenceByIdForOrganization(id: number, organizationId: number): Promise<Payment | undefined>;
