...
export interface ITeamStorage {
  ...
  deleteTeam(id: number, expectedOrganizationId?: number | null): Promise<void>;
...
export interface IPaymentStorage {
  ...
  getVisiblePaymentByIdForOrganization(id: number, organizationId: number): Promise<Payment | undefined>;
