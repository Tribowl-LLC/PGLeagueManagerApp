      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          {!applePayTokenizeOnly && applePayRef && (
            <div
              ref={applePayRef}
              className={applePayAvailable ? 'min-h-12 overflow-hidden rounded-md bg-black' : 'hidden'}
            />
          )}
          {applePayAvailable && applePayTokenizeOnly && onApplePayClick && (
            <button
              ...
              className="wallet-button h-12 gap-0.5 disabled:opacity-50"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="19" height="24" viewBox="0 0 17 20" fill="currentColor" className="relative -top-px text-white">
              ...
              <span className="wallet-label wallet-label-bowler">Pay</span>
            </button>
          )}
          {/*
          ...
          {!googlePayTokenizeOnly && googlePayRef && (
            <div
              ref={googlePayRef}
              className={googlePayAvailable ? 'min-h-12 overflow-hidden rounded-md bg-black' : 'hidden'}
            />
          )}
          {googlePayAvailable && googlePayTokenizeOnly && onGooglePayClick && (
            <button
              ...
              disabled={isWalletProcessing}
              className="wallet-button wallet-button-google h-12 gap-2 disabled:opacity-50"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="41" height="17" viewBox="0 0 41 17" fill="none" className="text-white">
                <path d="M19.4 8.5V13.1H18V1.8H21.5C22.4 1.8 23.2 2.1 23.8 2.7C24.5 3.3 24.8 4 24.8 4.9C24.8 5.8 24.5 6.5 23.8 7.1C23.2 7.7 22.4 8 21.5 8H19.4V8.5ZM19.4 3.2V7H21.5C22.1 7 22.6 6.8 23 6.4C23.4 6 23.6 5.5 23.6 4.9C23.6 4.4 23.4 3.9 23 3.5C22.6 3.1 22.1 2.9 21.5 2.9H19.4V3.2Z" fill="currentColor"/>
                <path d="M28.8 4.8C29.9 4.8 30.8 5.1 31.4 5.7C32 6.3 32.4 7.1 32.4 8.1V13.1H31.1V12H31C30.4 12.9 29.7 13.3 28.7 13.3C27.9 13.3 27.2 13 26.6 12.5C26.1 12 25.8 11.3 25.8 10.5C25.8 9.7 26.1 9 26.7 8.5C27.3 8 28.1 7.7 29.1 7.7C29.9 7.7 30.6 7.9 31.1 8.2V7.9C31.1 7.3 30.9 6.8 30.5 6.4C30.1 6 29.5 5.8 29 5.8C28.2 5.8 27.5 6.2 27.1 6.9L25.9 6.1C26.6 5.2 27.6 4.8 28.8 4.8ZM27.1 10.6C27.1 11 27.3 11.4 27.6 11.7C28 12 28.3 12.1 28.8 12.1C29.5 12.1 30 11.8 30.5 11.3C31 10.8 31.2 10.2 31.2 9.5C30.7 9.2 30 9 29.2 9C28.6 9 28.1 9.2 27.7 9.5C27.3 9.9 27.1 10.2 27.1 10.6Z" fill="currentColor"/>
                <path d="M38.6 5L34.4 14.6H33L34.7 11L32 5H33.5L35.5 10L37.5 5H38.6Z" fill="currentColor"/>
                <path d="M13 7.2C13 6.7 13 6.2 12.9 5.7H6.6V8.5H10.2C10 9.5 9.5 10.3 8.7 10.8V12.7H10.9C12.3 11.4 13 9.5 13 7.2Z" fill="var(--color-google-blue)"/>
                <path d="M6.6 14.5C8.5 14.5 10.1 13.9 10.9 12.7L8.7 10.8C8 11.3 7.4 11.5 6.6 11.5C4.8 11.5 3.3 10.2 2.7 8.5H0.5V10.4C1.6 12.7 3.9 14.5 6.6 14.5Z" fill="var(--color-google-green)"/>
                <path d="M2.7 8.5C2.5 8 2.4 7.5 2.4 6.9C2.4 6.3 2.5 5.8 2.7 5.3V3.4H0.5C-0.2 4.8 -0.2 9 0.5 10.4L2.7 8.5Z" fill="var(--color-google-yellow)"/>
                <path d="M6.6 2.3C7.5 2.3 8.3 2.6 9 3.2L11 1.3C10 0.4 8.4-0.1 6.6-0.1C3.9-0.1 1.6 1.7 0.5 3.4L2.7 5.3C3.3 3.6 4.8 2.3 6.6 2.3Z" fill="var(--color-google-red)"/>
              </svg>
            </button>
          )}
          {!googlePayAvailable && googlePayRef && (
            <div ref={googlePayRef} className="hidden" />
          )}
          {isWalletProcessing && (
          ...
          {cardMode === 'saved' && savedCards.length > 0 ? (
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-x-3">
                ...
                />
                <Label htmlFor="store-card-history" size="sm" className="cursor-pointer">
          ...
          {!bowlerHasEmail && onReceiptEmailChange && (
            <div className="space-y-2 rounded-md border bg-muted/30 p-3">
              <Label htmlFor="receipt-email" size="sm">
