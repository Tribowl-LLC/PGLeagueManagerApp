...
export function BowlerFinancialSummary({ league, financials, sourceLabel }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      {reviewRequired && <div className="md:col-span-3 rounded-md border border-warning-300 bg-warning-50 px-4 py-3 text-sm text-warning-900">Review required: {reviewCategory ?? "financial evidence"}. This evidence remains visible and is excluded from collectible totals until reviewed.</div>}
