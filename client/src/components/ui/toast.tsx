...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-data-[variant=destructive]:border-muted/40 group-data-[variant=destructive]:hover:border-destructive/30 group-data-[variant=destructive]:hover:bg-destructive group-data-[variant=destructive]:hover:text-destructive-foreground group-data-[variant=destructive]:focus:ring-destructive",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-data-[variant=destructive]:text-danger-300 group-data-[variant=destructive]:hover:text-danger-50 group-data-[variant=destructive]:focus:ring-danger-400 group-data-[variant=destructive]:focus:ring-offset-danger-600",
      className
    )}
    toast-close=""
    {...props}
