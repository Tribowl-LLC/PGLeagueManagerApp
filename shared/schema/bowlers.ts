...
export const bowlers = pgTable("bowlers", {
  ...
  // saved-customer record (`paymentCustomerId`).
...
export type InsertBowlerInput = z.input<typeof insertBowlerSchema>;
export type InsertBowler = z.output<typeof insertBowlerSchema>;
