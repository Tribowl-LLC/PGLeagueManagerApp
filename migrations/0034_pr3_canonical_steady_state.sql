...
BEGIN
  IF EXISTS (
    ...
    WHERE "status" NOT IN ('succeeded', 'action_required', 'reconciliation_required', 'failed_terminal', 'canceled')
  ) THEN
...
ALTER TABLE "payment_operation_roster_snapshots" ADD COLUMN "week_of" timestamp with time zone;--> statement-breakpoint
