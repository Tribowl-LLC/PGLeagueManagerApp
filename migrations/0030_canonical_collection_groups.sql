...
CREATE UNIQUE INDEX "financial_activation_cancellation_suppressions_activation_occurrence_unique" ON "financial_activation_cancellation_suppressions" USING btree ("organization_id","league_id","activation_id","occurrence_id");
